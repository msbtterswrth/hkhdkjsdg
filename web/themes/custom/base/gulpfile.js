...
const COMPONENT_SASS_SRC = "components/";
...
const COMPONENT_JS_SRC = "components/";
...
gulp.task("build-components-css", function (done) {
    ...
    return (
        gulp
            .src([`${COMPONENT_SASS_SRC}**/*.scss`])
            .pipe(sourcemaps.init({ largeFile: true }))
            .pipe(sass())
            .pipe(cssnano())
            .pipe(sourcemaps.write("."))
            .pipe(gulp.dest(`${COMPONENT_SASS_SRC}`))
    );
});
...
gulp.task("build-components-js", function (done) {
    return (
        gulp
            ...
            .pipe(gulp.dest(`${COMPONENT_JS_SRC}`))
    );
});
...
gulp.task("watch-sass", function () {
    gulp.watch(
        [
            ...
            `${COMPONENT_SASS_SRC}**/*.scss`,
        ],
        gulp.series("build-css", "build-components-css", "build-pages-css"));
});
gulp.task('watch-js', function () {
    gulp.watch(
        ...
        gulp.series("build-js", "build-components-js", "build-pages-js"));
});
